...
const CreateBillValidatorType = require('./types/create-bill-validator')
const createApex7000StateManager = require('./create-apex-7000-state-manager')
const BillValidator = require('./types/bill-validator')
...
module.exports = CreateBillValidatorType(createBillValidator)
